...
class MyTableView:
    ...
    def SetupUI(self):
        self.parent.setGeometry(50, 100, 700, 450)
        self.parent.setWindowTitle("MVC")
        ...
        self.layoutH1.addWidget(self.line_add)
        self.layoutH2.addWidget(self.btn_del)
        self.layoutH2.addWidget(self.line_del)
        self.layoutV.addLayout(self.layoutH1)
        self.layoutV.addLayout(self.layoutH2)
        self.layoutV.addWidget(self.btn_save)
        self.layout_main.addWidget(self.table_view, 3, 0)
